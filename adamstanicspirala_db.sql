...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2017 at 09:32 PM
...
(4, 'asd', 'adeds', 'Nesto', 'asd123', 'obicni', 'adam@yahoo.com'),
(5, 'Adem', 'adem', 'adem', 'aaaaa1', 'admin', 'adem@yaaaa.ba'),
(7, 'admin', 'irfff', 'admin', 'aaaaa1', 'admin', 'admin@admin.ba');
